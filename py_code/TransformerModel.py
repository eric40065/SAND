...
from OutputBlock import TransformerOutput, TransformerOutput_ver2
...
class Transformer(nn.Module):
    def __init__(self, model_settings, output_structure = "Vanilla"):
        ...
        if output_structure != "Vanilla":
            ...
            # model_settings2 = self.model_settings.copy()
            # model_settings2["num_hiddens"] = self.model_settings["f_in"][0]
            # self.outblock = TransformerOutput_ver2(model_settings2, output_structure)
    ...
    def forward(self, x, y_t, emb_m_mh, e_m_mh, d_m_mh, d_m, iteration = 0, TAs_position = None, isTraining = True):
        ...
        if self.output_structure == "Vanilla":
            ...
            smooth = self.outblock(org.detach().clone(), y_t, d_m, iteration, TAs_position, isTraining)
