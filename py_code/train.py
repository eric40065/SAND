...
model_settings = {"num_heads": 2, "num_layers": (2, 2), "num_q": 64, "num_k": 64, "num_v": 64, "num_hiddens": 64,\
                  "lr": 3e-4, "epoch_CV": 1000, "max_epoch": 2000 + 1, "dropout": 0.15, "check_loss": (0.1, 0.9),\
                  ...
                  "penalty_max_iter": 8, "penalty_min_iter": 5}
...
if denoise_method == "l1w" or denoise_method == "l2w" or denoise_method == "l2o" or denoise_method == "TVo":
    ...
    get_plot_scores_scatter(True, penalty_list, score, loss_valid_history, iidt, real, data_name, output_structure_folder, sparsity_error_folder, denoise_method)
    get_plot_scores_trend(True, penalty_list, score, model_settings, loss_valid_history, iidt, real, data_name, output_structure_folder, sparsity_error_folder, denoise_method)
